            ...
            <div class="cm_body">
                ...
                <div class="cm_bottom">
                    <div class="cm_curriculum">
                        <h4>학습 목표</h4>
                        <p class="cm_goal"></p>
                        <h4 style="margin-top:14px;">강좌 소개</h4>
                    ...
                    <div class="cm_right">
                        <div class="cm_section">
                            ...
                            <div class="cm_conditions">
                                <div class="cm_condition"><span class="cm_dot"></span><span class="cm_complete_text">전체 강좌 100% 수강 완료</span></div>
    ...
    function openCourseDetail(claNum) {
        $.ajax({
            ...
            success: function(data) {
                ...
                $('.cm_goal').text(data.claGoal || '정보 없음');
                $('.cm_content_text').text(data.claContent || '정보 없음');
                $('.cm_views').text((data.claViews || 0) + '회');
                $('.cm_status').text((data.applyCnt || 0) + '/' + data.claMaxStu);

                if (data.claComplete) {
                    $('.cm_complete_text').text(data.claComplete);
                }
                ...
                if (data.claThumb) {
                    $('#cm_thumb_img').attr('src', data.claThumb).show();
                } else {
                    $('#cm_thumb_img').hide();
                }

            ...
            <div class="search">
                <div class="search_area" style="display: flex; gap: 10px; width: 96%;">
                    <div style="position: relative; flex: 1;">
                        ...
                        <input type="text" placeholder="평가 관리 강의 검색"
                    ...
                    <tbody>
                        ...
                        <tr style="border-bottom: 1px solid #f1f1f1; transition: background 0.2s;">
                            ...
                            <td style="padding: 18px 15px; text-align: right; white-space: nowrap;">
                                <!-- 평가 발송 및 평가 제철 및 수료증 등록 및 수정하기 버튼 -->
                                 <button type="button"
                                ...
                                <button type="button"
                                    style="background: #fff; border: 1px solid #d1d1d1; color: #495057; padding: 7px 12px; border-radius: 4px; font-size: 13px; cursor: pointer; transition: all 0.2s; display: inline-flex; align-items: center; gap: 6px; margin-right: 35px;"
                                    onmouseover="this.style.backgroundColor='#f1f1f1'; this.style.opacity='0.8';"
                                    onmouseout="this.style.backgroundColor='#fff'; this.style.opacity='1';">
